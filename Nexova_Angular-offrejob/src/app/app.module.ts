...
import { JobApplicationsChartComponent } from './BackOffice/graph/job-applications-chart.component';
import { NgChartsModule } from 'ng2-charts'; // Correct import for the latest version
import { BrowserAnimationsModule } from '@angular/platform-browser/animations';
import { AiJobChatComponent } from './job-offers/ai-job-chat/ai-job-chat.component';
...
@NgModule({
  declarations: [
    AppComponent,
    AboutComponent, AppointmentComponent, ClaimsComponent, ContactComponent, DamageComponent, EspaceClientComponent, EventComponent, FeatureComponent, GetAQuoteComponent, IndexComponent, NewsComponent, ParticulierComponent, ProfessionnelComponent, RetirementComponent, SavingsComponent, TeamComponent, TestimonialComponent, JobOfferComponent, ApplicationComponent, ApplicationCreateComponent,JobApplicationsChartComponent, AiJobChatComponent
  ],
  imports: [
    BrowserModule,
    HttpClientModule,
